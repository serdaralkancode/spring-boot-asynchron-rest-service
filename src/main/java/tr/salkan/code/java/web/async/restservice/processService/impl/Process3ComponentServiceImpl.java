...
@Service
@Qualifier("modul3")
public class Process3ComponentServiceImpl implements ProcessComponentService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Process3ComponentServiceImpl.class);
    ...
    public ResponseObject makeProcess(List<Person> personList, ProcessModulEnum modul) {
        ...
        personList.forEach(person -> {
            ...
            //System.out.println("process 3 - person number " + person.getNumber());

            if(person.getNumber()%2 == 0)
            {
